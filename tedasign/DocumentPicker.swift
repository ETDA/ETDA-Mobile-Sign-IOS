...
open class DocumentPicker: NSObject {
    ...
    public func displayPicker() {
        ...
        let supportedTypes: [String] = ["public.data"]
        self.pickerController = UIDocumentPickerViewController(documentTypes: supportedTypes, in: .import)
